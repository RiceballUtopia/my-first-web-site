...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const outcomes = {
    hot: { title: "ほかほか鯛", desc: "焼きたて命。香ばしい瞬間を逃さないあなたに。", store: "できたて提供の屋台・実演販売店でどうぞ。" },
    mochi: { title: "包容力モッチリ鯛", desc: "外カリ中モチ厚皮派。どっしり満足感がほしいタイプ。", store: "厚め生地の老舗たい焼き専門店。" },
    seasonal: { title: "季節追いかけ鯛", desc: "限定フレーバー巡りが性に合う冒険派。", store: "季節餡や変わり種が多いチェーン（抹茶・さつまいも・栗など）。" },
    classic: { title: "きっちり定番鯛", desc: "王道こそ正義。ブレない一本筋タイプ。", store: "薄皮×小豆一本勝負の老舗。" },
    share: { title: "おすそ分け鯛", desc: "箱買い・手土産が似合うシェア上手。", store: "個包装が丁寧な和菓子系たい焼き店。" },
    salty: { title: "塩見の効いた鯛", desc: "甘さ控えめでバランス重視。", store: "十勝産小豆や塩バター餡の専門店。" },
    light: { title: "サクふわ中庸鯛", desc: "軽めにサクッと楽しみたい。", store: "クロワッサンたい焼き系カフェ。" },
    mini: { title: "冒険小さめ鯛", desc: "小回りの利く変わり種を一つ。", store: "チーズ・カレー・明太マヨなど総菜系たい焼き店。" },
    steady: { title: "慎重ほっとり鯛", desc: "まずは一番人気を押さえる慎重派。", store: "行列の定番店でまずは粒あん。" },
    cool: { title: "冷静しっぽ鯛", desc: "実はそこまで甘党じゃないかも。", store: "白餡・こし餡の軽め、もしくは最中・鯛せんべい系の専門店。" },
  };
